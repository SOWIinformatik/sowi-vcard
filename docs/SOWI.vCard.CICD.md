...
5. Release in GitHub Releases dokumentieren: `CHANGELOG.md` ergänzen, `New-GitHubRelease.ps1` ausführen (siehe Anhang E).
...
### Anhang D – Branch Protection (`main`)
...
### Anhang E – GitHub Releases und Changelog
