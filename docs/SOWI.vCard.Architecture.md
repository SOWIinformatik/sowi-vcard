...
Dieses Dokument beschreibt die **Architektur und Coding Standards** der Bibliothek (Clean Architecture light). Abschnitt [Bewusste Abweichungen vom DDD-Zielbild](#bewusste-abweichungen-vom-ddd-zielbild) erklärt bewusst pragmatische Designentscheidungen gegenüber einem strikten DDD-Sollbild.

### Dokumentenaufbau

| Teil | Inhalt |
| ---- | ------ |
| **Architektur** | Schichten, Ordnerstruktur, Patterns und Code-Beispiele |
...
Folgende Abweichungen vom strikten DDD-Sollbild sind **bewusst** und für eine Format-Bibliothek üblich:
...
| **GitHub Actions** | Build, Test, Pack | Aktiv (`.github/workflows/ci.yml`, `release.yml`) |
